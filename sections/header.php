            ...
            <div class="header-inner">
                <div class="header-left">
                    <div class="logo-thumbnail logo-custom-css">
                        <a class="logo-light" href="index.php"><img src="assets/images/logo/Logo-blue.png" alt="ocw-logo"></a>
                        <a class="logo-dark" href="index.php"><img src="assets/images/logo/Logo-blue.png" alt="ocw-logo"></a>
                    </div>
                    <div class="mainmenu-wrapper">
                        <nav id="sideNav" class="mainmenu-nav d-none d-xl-block">
                            ...
                            <ul class="mainmenu">
                                <li>
                                    <a class="its_new" href="index.php">Home</a>
                                </li>
                                <li><a href="about.html">About</a>
                                </li>
                                <li>
                                    <a class="its_new" href="explore.php">Explore</a>
                                </li>
