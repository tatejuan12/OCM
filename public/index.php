    ...
    <div class="popup-mobile-menu">
        <div class="inner">
            ...
            <nav>
                ...
                <ul class="mainmenu">
                    <li>
                        <a class="nav-link its_new" href="index.php">Home</a>
                    </li>
                    <li><a href="about.html">About</a>
                    </li>
                    <li>
                        <a class="nav-link its_new" href="explore.php">Explore</a>
                    </li>
            ...
            <div class="row row-reverce-sm align-items-center">
                <div class="col-lg-5 col-md-6 col-sm-12 mt_sm--50">
                    ...
                    <div class="button-group">
                        <a class="btn btn-large btn-primary" href="explore.php" data-sal-delay="400" data-sal="slide-up" data-sal-duration="800">Get Started</a>
                    </div>
                </div>
