...
exports.normalizeNode = (affectedNode) => {
    const diffType = Object.keys(affectedNode)[0];
    const node = affectedNode[diffType];
    return Object.assign({}, Object.assign(Object.assign({}, node), { diffType, entryType: node.LedgerEntryType, ledgerIndex: node.LedgerIndex, newFields: node.NewFields || {}, finalFields: node.FinalFields || {}, previousFields: node.PreviousFields || {} }));
};
exports.normalizeNodes = (metadata) => {
    if (!metadata.AffectedNodes) {
        return [];
    }
    return metadata.AffectedNodes.map(exports.normalizeNode);
};
...
exports.nftValuetoXrpl = (value, accountBalance) => {
    ...
    if (typeof accountBalance !== 'undefined' && exports.xrplValueToNft(accountBalance) === false) {
