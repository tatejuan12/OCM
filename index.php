...
<head>
    ...
    <title>OCW Marketplace || Home</title>
    ...
    <div class="popup-mobile-menu">
        <div class="inner">
            ...
            <nav>
                ...
                <ul class="mainmenu">
                    <li>
                        <a class="nav-link its_new" href="index.html">Home</a>
                    </li>
                    <li><a href="about.html">About</a>
                    </li>
                    <li>
                        <a class="nav-link its_new" href="explore-one.html">Explore</a>
                    </li>
                    <li><a href="contact.html">Contact</a></li>
                </ul>
                <!-- End Mainmanu Nav -->
        ...
        <div class="container">
            <div class="row row-reverce-sm align-items-center">
                <div class="col-lg-5 col-md-6 col-sm-12 mt_sm--50">
                    <h2 class="title" data-sal-delay="200" data-sal="slide-up" data-sal-duration="800">Welcome To The OCW Marketplace</h2>
                    <p class="slide-disc" data-sal-delay="300" data-sal="slide-up" data-sal-duration="800">Buy, sell and express your creativity in the OnChain Whales ecosystem bringing creativity to the world of NFT's.</p>
                    <div class="button-group">
                        <a class="btn btn-large btn-primary" href="explore-one.html" data-sal-delay="400" data-sal="slide-up" data-sal-duration="800">Get Started</a>
                    </div>
                </div>
                <div class="col-lg-5 col-md-6 col-sm-12 offset-lg-1">
                    <div class="slider-thumbnail float">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 mb--50">
                    <h3 class="title" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">Create and sell your Whales</h3>
                </div>
            </div>
            <div class="row g-5">
                    ...
                    <div data-sal="slide-up" data-sal-delay="150" data-sal-duration="800" class="rn-service-one color-shape-7">
                        <div class="inner">
                            ...
                            <div class="content">
                                ...
                                <p class="description">Sign In to our platform with your XUMM wallet. </p>
                    ...
                    <div data-sal="slide-up" data-sal-delay="250" data-sal-duration="800" class="rn-service-one color-shape-5">
                        <div class="inner">
                            ...
                            <div class="content">
                                ...
                                <p class="description">List your NFT's on our platform for people to browse through.</p>
                                <a class="read-more-button" href="#"><i class="feather-arrow-right"></i></a>
                            </div>
                        </div>
                        <a class="over-link" href="#"></a>
                    ...
                    <div data-sal="slide-up" data-sal-delay="300" data-sal-duration="800" class="rn-service-one color-shape-6">
                        <div class="inner">
                            ...
                            <div class="content">
                                ...
                                <p class="description">When you are ready, list your NFT's for sale.</p>
                                <a class="read-more-button" href="#"><i class="feather-arrow-right"></i></a>
                            </div>
                        </div>
                        <a class="over-link" href="#"></a>
